...
<body>
	<center>
		<h4>
			DAFTAR PENILAIAN (CHECK LIST) PERMOHONAN SERTIFIKAT BADAN USAHA JASA PENUNJANG TENAGA LISTRIK
		</h4>	
	</center>
	...
	<div class="card">
	    <div class="card-header">
	        <h4 class="card-header-title">Identifikasi Pemohon</h4>
	    </div>
	    <div class="card-body">
	...
	<table id="table-identitas-badan-usaha" class="table">
		<thead>
			<tr>
	...
	<table id="table-persyaratan-administratif" class="table">
		<thead>
			<tr>
				<th style="width: 20%;">Point Verifikasi</th>
	...
	<table id="table-persyaratan-teknis" class="table">
		<thead>
			<tr>
				<th style="width: 20%;">Point Verifikasi</th>
				<th style="width: 20%;">Isi Point</th>
