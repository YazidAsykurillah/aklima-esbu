...
@section('page_title')
    Master Data :: Lingkup Pekerjaan LSBU
@endsection

@section('page_header_title')
<h2 class="pageheader-title">Master Data : Lingkup Pekerjaan LSBU</h2>
@endsection
...
<div class="page-breadcrumb">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Master Data Lingkup Pekerjaan LSBU</li>
        </ol>
    </nav>
</div>
@endsection
...
<div class="card">
    <div class="card-header d-flex">
        <h4 class="card-header-title">Lingkup Pekerjaan LSBU</h4>
        ...
        <div class="table-responsive">
            <table class="table" id="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">uid_lsbu_lingkup_pekerjaan</th>
                        <th scope="col">uid_lsbu</th>
                        <th scope="col">uid_jenis_usaha</th>
                        <th scope="col">uid_bidang</th>
                        <th scope="col">uid_sub_bidang</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        var table =  $('#table').DataTable({
            processing :true,
            serverSide : true,
            ajax : '{!! url('lingkup-pekerjaan-lsbu/datatables') !!}',
            columns :[
                {data: 'rownum', name: 'rownum', searchable:false},
                { data: 'uid_lsbu_lingkup_pekerjaan', name: 'uid_lsbu_lingkup_pekerjaan'},
        ...
        $('#btn-synchronize').on('click', function(event){
            ...
            $.ajax({
                ...
                url: '{{ url('lingkup-pekerjaan-lsbu/synchronize') }}', // This is the url we gave in the route
