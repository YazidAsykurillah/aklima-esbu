                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            ...
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_uid_verifikasi_pa"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File Akta Pendirian BU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_akta_pendirian_bu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nama Notaris</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nama_notaris"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Judul Akta</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_judul_akta"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tanggal Akta</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tanggal_akta"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor Akta</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_akta"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Maksud Tujuan Akta</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_maksud_tujuan_akta"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File Pengesahan Sebagai Badan Hukum</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_pengesahan_sebagai_badan_hukum"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor Badan Hukum</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_badan_hukum"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tentang Badan Hukum</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tentang_badan_hukum"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tanggal Badan Hukum</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tanggal_badan_hukum"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File NPWP</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_npwp"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor NPWP</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_npwp"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File SKDU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_skdu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Instansi Penerbit SKDU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_instansi_penerbit_skdu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor SKDU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_skdu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tanggal SKDU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tanggal_skdu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Masa Berlaku SKDU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_masa_berlaku_skdu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File PJBU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_pjbu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nama PJBU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nama_pjbu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Jenis Identitas PJBU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_jenis_identitas_pjbu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor KTP PJBU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_ktp_pjbu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor Paspor PJBU</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_paspor_pjbu"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File Laporan Keuangan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_laporan_keuangan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Kekayaan Bersih</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_kekayaan_bersih"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Modal Disetor</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_modal_disetor"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nama Kantor Akuntan Publik</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nama_kantor_akuntan_publik"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Alamat Kantor Akuntan Publik</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_alamat_kantor_akuntan_pulik"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor Telepon Kantor Akuntan Publik</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_telepon_kantor_akuntan_publik"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nama Akuntan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nama_akuntan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor Laporan Keuangan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_laporan_keuangan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tanggal Laporan Keuangan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tanggal_laporan_keuangan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Pendapat Akuntan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_pendapat_akuntan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File Struktur Organisasi Badan Usaha</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_struktur_organisasi_badan_usaha"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File Profile Badan Usaha</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_profile_badan_usaha"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File PPM</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_ppm"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor PPM</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_ppm"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tanggal PPM</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tanggal_ppm"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Prosentase Saham PMA PPM</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_prosentase_saham_pma_ppm"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">File PPM Perubahan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_file_ppm_perubahan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Nomor PPM Perubahan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_nomor_ppm_perubahan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Tanggal PPM Perubahan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_tanggal_ppm_perubahan"></td>
                        </tr>
                        <tr>
                            <td style="width: 30%;">Prosentase Saham PMA PPM Perubahan</td>
                            <td style="width: 5%;">:</td>
                            <td style="" id="pa_holder_prosentase_saham_pma_ppm_perubahan"></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <form id="form-tambah-persyaratan-administratif" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_akta_pendirian_bu">File Akta Pendirian BU</label>
                        <input type="file" class="custom-file-input" id="file_akta_pendirian_bu" name="file_akta_pendirian_bu" >
                    </div>
                    ...
                    <div class="form-group">
                        <label for="maksud_tujuan_akta" class="col-form-label">maksud_tujuan_akta</label>
                        <input id="maksud_tujuan_akta" name="maksud_tujuan_akta" type="text" class="form-control"  />
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_pengesahan_sebagai_badan_hukum">file_pengesahan_sebagai_badan_hukum</label>
                        <input type="file" class="custom-file-input" id="file_pengesahan_sebagai_badan_hukum" name="file_pengesahan_sebagai_badan_hukum" >
                    </div>
                    <div class="form-group">
                        <label for="nomor_badan_hukum" class="col-form-label">nomor_badan_hukum</label>
                        <input id="nomor_badan_hukum" name="nomor_badan_hukum" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="tentang_badan_hukum" class="col-form-label">tentang_badan_hukum</label>
                    ...
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_npwp">File NPWP</label>
                        <input type="file" class="custom-file-input" id="file_npwp" name="file_npwp" >
                    </div>
                    <div class="form-group">
                        <label for="nomor_npwp" class="col-form-label">nomor_npwp</label>
                        <input id="nomor_npwp" name="nomor_npwp" type="text" class="form-control"  />
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_skdu">File SKDU</label>
                        <input type="file" class="custom-file-input" id="file_skdu" name="file_skdu" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_pjbu">File PJBU</label>
                        <input type="file" class="custom-file-input" id="file_pjbu" name="file_pjbu" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="jenis_identitas_pjbu" class="col-form-label">jenis_identitas_pjbu</label>
                        <input id="jenis_identitas_pjbu" name="jenis_identitas_pjbu" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="nomor_ktp_pjbu" class="col-form-label">nomor_ktp_pjbu</label>
                        <input id="nomor_ktp_pjbu" name="nomor_ktp_pjbu" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="nomor_paspor_pjbu" class="col-form-label">nomor_paspor_pjbu</label>
                        <input id="nomor_paspor_pjbu" name="nomor_paspor_pjbu" type="text" class="form-control"  />
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_laporan_keuangan">File Laporan Keuangan</label>
                        <input type="file" class="custom-file-input" id="file_laporan_keuangan" name="file_laporan_keuangan" >
                    </div>
                    <div class="form-group">
                        <label for="kekayaan_bersih" class="col-form-label">kekayaan_bersih</label>
                        <input id="kekayaan_bersih" name="kekayaan_bersih" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="modal_disetor" class="col-form-label">modal_disetor</label>
                        <input id="modal_disetor" name="modal_disetor" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="nama_kantor_akuntan_publik" class="col-form-label">nama_kantor_akuntan_publik</label>
                        <input id="nama_kantor_akuntan_publik" name="nama_kantor_akuntan_publik" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="alamat_kantor_akuntan_pulik" class="col-form-label">alamat_kantor_akuntan_pulik</label>
                        <input id="alamat_kantor_akuntan_pulik" name="alamat_kantor_akuntan_pulik" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon_kantor_akuntan_publik" class="col-form-label">nomor_telepon_kantor_akuntan_publik</label>
                        <input id="nomor_telepon_kantor_akuntan_publik" name="nomor_telepon_kantor_akuntan_publik" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="nama_akuntan" class="col-form-label">nama_akuntan</label>
                        <input id="nama_akuntan" name="nama_akuntan" type="text" class="form-control"  />
                    </div>
                    <div class="form-group">
                        <label for="nomor_laporan_keuangan" class="col-form-label">nomor_laporan_keuangan</label>
                    ...
                    <div class="form-group">
                        <label for="pendapat_akuntan" class="col-form-label">pendapat_akuntan</label>
                        <input id="pendapat_akuntan" name="pendapat_akuntan" type="text" class="form-control"  />
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_struktur_organisasi_badan_usaha">File Struktur Organisasi Badan Usaha</label>
                        <input type="file" class="custom-file-input" id="file_struktur_organisasi_badan_usaha" name="file_struktur_organisasi_badan_usaha" >
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_profile_badan_usaha">File Profile Badan Usaha</label>
                        <input type="file" class="custom-file-input" id="file_profile_badan_usaha" name="file_profile_badan_usaha" >
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_ppm">File PPM</label>
                        <input type="file" class="custom-file-input" id="file_ppm" name="file_ppm" >
                    </div>
                    <div class="form-group">
                        <label for="nomor_ppm" class="col-form-label">nomor_ppm</label>
                    ...
                    <div class="form-group">
                        <label for="prosentase_saham_pma_ppm" class="col-form-label">prosentase_saham_pma_ppm</label>
                        <input id="prosentase_saham_pma_ppm" name="prosentase_saham_pma_ppm" type="text" class="form-control"  />
                    </div>
                    <div class="custom-file mb-3">
                        <label class="custom-file-label" for="file_ppm_perubahan">File PPM Perubahan</label>
                        <input type="file" class="custom-file-input" id="file_ppm_perubahan" name="file_ppm_perubahan" >
                    </div>
                    <div class="form-group">
                        <label for="nomor_ppm_perubahan" class="col-form-label">nomor_ppm_perubahan</label>
                    ...
                    <div class="form-group">
                        <label for="prosentase_saham_pma_ppm_perubahan" class="col-form-label">prosentase_saham_pma_ppm_perubahan</label>
