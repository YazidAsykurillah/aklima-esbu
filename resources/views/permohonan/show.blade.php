...
<script type="text/javascript">
    ...
    //ENDBlock Asesor
        ...
        //Block Verifikasi IBU
            ...
            //Block Submit Verifikasi Identitas Badan Usaha
            $('#form-verifikasi-ibu').on('submit', function(){
                $('#btn-submit-ver-ibu').prop('disabled', true);
            });
            //ENDBlock Submit Verifikasi Identitas Badan Usaha

        //ENDBlock Verifikasi IBU

        //Block Verifikasi PA
            //Block get verifikasi PA of permohonan
            $.ajax({
                type: 'GET',
                url: '{{ url('permohonan') }}/{{ $permohonan->uid_permohonan }}/verifikasi-pa', 
                success: function (response) {
            ...
            //ENDBlock get verifikasi PA of permohonan
            ...
            //Block Submit Verifikasi Persyaratan Administratif
            $('#form-verifikasi-pa').on('submit', function(){
                $('#btn-submit-ver-pa').prop('disabled', true);
            });
            //ENDBlock Submit Verifikasi Persyaratan Administratif

        //ENDBlock Verifikasi PA


        //Block Verifikasi PT
            //Block get verifikasi PT of permohonan
            $.ajax({
                type: 'GET',
                url: '{{ url('permohonan') }}/{{ $permohonan->uid_permohonan }}/verifikasi-pt', 
                success: function (response) {
                    console.log('Get Verifikasi PT');
                    console.log(response);
                    if(response.data != null){
                        //Data Verifikasi pt
                        let dataVerPt = response.data;

                        //---
                        if(dataVerPt.hasil_ver_pt == true){
                            $('#form-verifikasi-pt').find('input[name=hasil_ver_pt][value=1]').prop('checked', true);
                        }else{
                            $('#form-verifikasi-pt').find('input[name=hasil_ver_pt][value=0]').prop('checked', true);
                        }
                        $('#form-verifikasi-pt').find('textarea[name=catatan_ver_pt]').val(dataVerPt.catatan_ver_pt);
                        //###
                    }
                },
                error: function() { 
            ...
            //ENDBlock get verifikasi PT of permohonan

            //Block Verifikasi PT check all & uncheck all
            $('#btn-check-all-ver-pt').on('click', function(event){
                event.preventDefault();
                $('#form-verifikasi-pt').find('.hasil_ver_pt_radio[value=1]').prop('checked', true);
            });

            $('#btn-uncheck-all-ver-pt').on('click', function(event){
                event.preventDefault();
                $('#form-verifikasi-pt').find('.hasil_ver_pt_radio[value=0]').prop('checked', true);
            });
            //ENDBlock Verifikasi PT check all & uncheck all

            //Block Submit Verifikasi Persyaratan Teknis
            $('#form-verifikasi-pt').on('submit', function(){
                $('#btn-submit-ver-pt').prop('disabled', true);
            });
            //ENDBlock Submit Verifikasi Persyaratan Teknis

        //ENDBlock Verifikasi PT


        //Block Verifikasi Dewan Pengurus
            //Block GET verifikasi Dewan Pengurus of permohonan
            $.ajax({
                type: 'GET',
                url: '{{ url('permohonan') }}/{{ $permohonan->uid_permohonan }}/verifikasi-dp', 
                success: function (response) {
                    console.log('GET Verifikasi Dewan Pengurus');
                    console.log(response);
                    if(response.data != null){
                        //Data Verifikasi Dewan Pengurus
                        let dataVerDp = response.data;

                        //---
                        if(dataVerDp.hasil_ver_dp_dk == true){
                            $('#form-verifikasi-dp').find('input[name=hasil_ver_dp_dk][value=1]').prop('checked', true);
                        }else{
                            $('#form-verifikasi-dp').find('input[name=hasil_ver_dp_dk][value=0]').prop('checked', true);
                        }
                        $('#form-verifikasi-dp').find('textarea[name=catatan_ver_dp_dk]').val(dataVerDp.catatan_ver_dp_dk);
                        //###

                        //---
                        if(dataVerDp.hasil_ver_dp_dd == true){
                            $('#form-verifikasi-dp').find('input[name=hasil_ver_dp_dd][value=1]').prop('checked', true);
                        }else{
                            $('#form-verifikasi-dp').find('input[name=hasil_ver_dp_dd][value=0]').prop('checked', true);
                        }
                        $('#form-verifikasi-dp').find('textarea[name=catatan_ver_dp_dd]').val(dataVerDp.catatan_ver_dp_dd);
                        //###

                        //---
                        if(dataVerDp.hasil_ver_dp_ps == true){
                            $('#form-verifikasi-dp').find('input[name=hasil_ver_dp_ps][value=1]').prop('checked', true);
                        }else{
                            $('#form-verifikasi-dp').find('input[name=hasil_ver_dp_ps][value=0]').prop('checked', true);
                        }
                        $('#form-verifikasi-dp').find('textarea[name=catatan_ver_dp_ps]').val(dataVerDp.catatan_ver_dp_ps);
                        //###
                    }
                },
                error: function() { 
            ...
            //ENDBlock GET verifikasi Dewan Pengurus of permohonan

            //Block Verifikasi Dewan Pengurus check all & uncheck all
            $('#btn-check-all-ver-dp').on('click', function(event){
                event.preventDefault();
                $('#form-verifikasi-dp').find('.hasil_ver_dp_radio[value=1]').prop('checked', true);
            });

            $('#btn-uncheck-all-ver-dp').on('click', function(event){
                event.preventDefault();
                $('#form-verifikasi-dp').find('.hasil_ver_dp_radio[value=0]').prop('checked', true);
            });
            //ENDBlock Verifikasi Dewan Pengurus check all & uncheck all

            //Block Submit Verifikasi Dewan Pengurus
            $('#form-verifikasi-dp').on('submit', function(){
                $('#btn-submit-ver-dp').prop('disabled', true);
            });
            //ENDBlock Submit Verifikasi Dewan Pengurus

        //ENDBlock Verifikasi Dewan Pengurus
