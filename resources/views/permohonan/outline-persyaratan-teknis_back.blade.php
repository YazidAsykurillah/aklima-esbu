    ...
    <div class="col-md-12">
        ...
        <div class="tab-outline">
            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="tab-outline-persyaratan-administratif" href="{{ url('permohonan/'.$permohonan->uid_permohonan.'/outline-persyaratan-administratif') }}">
                        <i class="fas fa-file-alt"></i> Persyaratan Administratif
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" id="tab-outline-persyaratan-teknis" href="{{ url('permohonan/'.$permohonan->uid_permohonan.'/outline-persyaratan-teknis') }}">
