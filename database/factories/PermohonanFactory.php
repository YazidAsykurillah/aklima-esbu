...
$factory->define(App\Permohonan::class, function (Faker $faker) {
    return [
    	...
    	//'status'=>$faker->randomElement($array = array ('0','1', '4', '5', '6','7', '10', '11', '12', '14')) // 'b'
    	'status'=>$faker->randomElement($array = array ('0', '11')) // 'Limit to only permohonan with status menunggu permohonan and nomor registrasi'
    ];
});
