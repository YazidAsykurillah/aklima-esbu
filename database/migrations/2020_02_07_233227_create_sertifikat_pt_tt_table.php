...
class CreateSertifikatPtTtTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sertifikat_pt_tt', function (Blueprint $table) {
            $table->increments('id');
            $table->bigInteger('uid_permohonan');
            $table->bigInteger('uid_verifikasi_pt');
            $table->bigInteger('uid_ver_pt_tt');
    ...
    {
        Schema::dropIfExists('sertifikat_pt_tt');
    }
}
